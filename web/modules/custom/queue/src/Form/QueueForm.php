...
class QueueForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (isset($_GET['num'])) {
          ...
          $form_state->setRedirect('queue.display_table_controller_display');
       ...
       else
       {
           ...
           $response = new RedirectResponse("/queue/hello/table");
           $response->send();
       }
     }
